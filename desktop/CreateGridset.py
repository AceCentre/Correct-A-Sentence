...
def modify_gridset(gridset_path, LocalAppPath):
	...
	for foldername, _, filenames in os.walk(temp_dir):
		for filename in filenames:
			if filename.endswith('.xml'):
				...
				full_path_to_exe = os.path.join(local_app_data_path, 'Ace Centre', 'CorrectSentence', 'client', 'client.exe')
	...
	new_gridset_dir = os.path.join(LocalAppPath, 'Ace Centre', 'CorrectSentence', 'Example CorrectSentence Page')
...
if __name__ == "__main__":
	...
	gridset_location = os.path.join(app_data_path, 'Ace Centre', 'CorrectSentence', 'CorrectASentenceDemo.gridset')  # Updated path

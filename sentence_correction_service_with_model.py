...
sentence_model = api.model('Sentence', {
    ...
    'correction_method': fields.String(required=False, description='Correction method: "gpt", "inbuilt", "inbuiltmodel"', enum=['gpt', 'inbuilt','inbuiltmodel'])
})
...
def correct_with_inbuiltmodel(input_string):
...
class SentenceCorrection(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            elif correction_method == 'inbuiltmodel':
                corrected_sentence = correct_with_inbuiltmodel(input_string)            
            else:
